...
<div class="banner slideshow">
    <div class="slideshow-item">
        <img src="<?php echo home_url(); ?>/wp-content/uploads/2020/11/josh_b1.jpg" alt="banner_1">
        <div class="slideshow-text text-white">
            <div>Early detection of Hearing Impairment Helps</div>
        </div>
    </div>
    <div class="slideshow-item">
        <img src="<?php echo home_url(); ?>/wp-content/uploads/2020/11/josh_home_banner_2.jpg" alt="banner_2">
        <div class="slideshow-text text-white">
            <div>Provided Hearing Aid to 1000+ Children</div>
        </div>
    </div>
    <div class="slideshow-item">
        <img src="<?php echo home_url(); ?>/wp-content/uploads/2020/11/hearing-aid.jpg" alt="summer">
        <div class="slideshow-text text-white">
