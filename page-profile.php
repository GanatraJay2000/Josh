...
<div>
    <div class="heading px-4 px-md-5 pb-4 pb-md-5 pt-md-0 pt-4">
        <h1 class="display-2 not-on-phone josh-page-title">JOSH</h1>
        <p>
            JOSH is a movement which was initiated by<br class="not-on-phone"> eminent ENT surgeon <span class="red">Dr. Jayant Gandhi</span> and <span class="red">Devangi Dalal</span> a renowned audiologist.
        </p>
    </div>
    <div class="row d-flex flex-md-row flex-column">
        ...
        <div class="col-lg-6 row-info">
            ...
            <p>
                With proper care and support all such children can, over a period of time, begin to hear well enough to respond to the spoken word and better integrate with society.
            </p>
            <p>
                JOSH has been working towards this noble goal over the last 14 years.
            </p>
            <p>
